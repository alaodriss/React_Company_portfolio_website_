          ...
          <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
            <div className="footer-about-section">
              ...
              <p>
                ...
                rapidement, il est plutôt réservé aux développeurs web. En
                effet, en plus de générer du texte, il génère également un
                squelette HTML ainsi que des balises HTML pré-remplies afin
